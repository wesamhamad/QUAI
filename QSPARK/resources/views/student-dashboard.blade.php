...
<div class="space-y-6">
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-2xl p-4 shadow text-center">
        ...
        <a href="{{ route('dashboard.student.chat') }}" class="w-full bg-dga-primary-500 hover:bg-dga-primary-600 text-white py-2 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  chatForm?.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      const response = await fetch('{{ route("dashboard.student.chat.send") }}', {
        method: 'POST',
        headers: {
