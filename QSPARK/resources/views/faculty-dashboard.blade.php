  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
    ...
    <div class="space-y-6">
      <div class="bg-white rounded-2xl p-6 shadow">
        ...
        <div class="space-y-3">
          <a href="{{ route('faculty.courses') }}" class="block w-full bg-dga-primary-500 text-white text-center py-3 rounded-xl hover:bg-dga-primary-600 transition flex items-center justify-center gap-2">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>
            </svg>
            {{ __('messages.my_courses_blackboard') }}
          </a>
          <a href="{{ route('faculty.students') }}" class="block w-full bg-green-500 text-white text-center py-3 rounded-xl hover:bg-green-600 transition">
            {{ __('messages.student_list') }}
          </a>
          <a href="{{ route('faculty.reports') }}" class="block w-full bg-dga-primary-500 text-white text-center py-3 rounded-xl hover:bg-dga-primary-600 transition">
            {{ __('messages.reports') }}
          </a>
        </div>
      </div>
...
<script>
  ...
  function getAISuggestions(areaName, errorRate, studentsAffected) {
    ...
    // Call AI API
    fetch('{{ route("faculty.ai-suggestions") }}', {
      method: 'POST',
      headers: {
