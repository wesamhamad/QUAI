...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.roles') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition">
                    ...
                    @forelse($usersWithRole as $user)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.users.edit', $user->id) }}" class="text-dga-primary-600 hover:text-dga-primary-900">{{ __('messages.edit_action') }}</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
