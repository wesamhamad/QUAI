...
use App\Services\OpenAiQuizGenerator;
...
class QuizController extends Controller
{
    ...
    public function exportQuestionsForStudent(Request $request)
    {
        ...
        if (\App\Models\StudentQuizExport::hasExported($studentId, $attachmentKey)) {
            return response()->json([
                'success' => false,
        ...
        // Record the export
        \App\Models\StudentQuizExport::recordExport(
            $studentId,
            $courseCode,
            $attachmentKey,
            $questions->count(),
    ...
    public function checkExportStatus(Request $request)
    {
        ...
        $hasExported = \App\Models\StudentQuizExport::hasExported($studentId, $attachmentKey);
