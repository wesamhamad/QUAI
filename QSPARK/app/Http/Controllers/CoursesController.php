...
class CoursesController extends Controller
{
    ...
    private function fetchStudentCoursesForLookup()
    {
        ...
        try {
            ...
            if ($data === null) {
                ...
                if ($data !== null) {
                    \App\Support\StudentFixture::logServed('CoursesController.fetchStudentCoursesForLookup', '/api/v2/student/courses');
                }
            }
    ...
    private function fetchCourseContentsList($externalId)
    {
        ...
        $fallback = \App\Support\StudentFixture::blackboardContents($externalId);
        if ($fallback !== null) {
            \App\Support\StudentFixture::logServed('fetchCourseContentsList', "/blackboard/courses/{$externalId}/contents/v2");
