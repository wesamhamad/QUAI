...
class SISService
{
    ...
    private function demoFacultyCourses($instructorId, $semester = null): array
    {
        ...
        $rows = \App\Models\FacultyCourseCache::getInstructorCourses($instructorId, $semester);
    ...
    private function demoFacultyStudents($instructorId, $semester = null, bool $requireGpa = false): array
    {
        $semester = $semester ?: '462';
        $rows = $requireGpa
            ? \App\Models\FacultyStudentCache::getAllWithGPA($instructorId, $semester)
            : \App\Models\FacultyStudentCache::getInstructorStudents($instructorId, $semester);
