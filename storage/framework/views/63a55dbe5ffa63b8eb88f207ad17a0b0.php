<?php $__env->startSection('title', 'QUAI - منصة الذكاء الاصطناعي'); ?>
...
<div class="q-fade-in q-home" style="max-width: var(--q-content-max); margin: 0 auto;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFaculty): ?>
    
    <a href="<?php echo e(route('faculty.students')); ?>" class="q-card" style="display:flex; align-items:center; gap: var(--q-space-4); padding: var(--q-space-5); margin-bottom: var(--q-space-6); text-decoration:none; color:inherit; border: 2px solid rgba(37,147,95,0.25);">
    ...
    <div class="q-systems-grid" data-cols="<?php echo e($showQSparkSystem && $showQDecisionSystem ? '2' : '1'); ?>" style="display: grid; grid-template-columns: <?php echo e($showQSparkSystem && $showQDecisionSystem ? 'repeat(2, minmax(0, 1fr))' : '1fr'); ?>; gap: var(--q-space-6); margin-bottom: var(--q-space-8); align-items: stretch;">

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQSparkSystem): ?>
        ...
        <section class="q-card q-system-card" style="padding: var(--q-space-6); display: flex; flex-direction: column; gap: var(--q-space-5);">
            ...
            <div class="q-sub-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: var(--q-space-4);">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQMentor): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDigitalRecord): ?>
                <a href="<?php echo e(route('digital-record.index')); ?>" class="q-sub-card" data-tone="green">
                    <div class="q-sub-card-icon">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQDecisionSystem): ?>
        ...
        <section class="q-card q-system-card" style="padding: var(--q-space-6); display: flex; flex-direction: column; gap: var(--q-space-5);">
            ...
            <div class="q-sub-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: var(--q-space-4);">
                <a href="<?php echo e(route('q-decision.self-report')); ?>" class="q-sub-card" data-tone="purple">
                    <div class="q-sub-card-icon">
                ...
                <a href="<?php echo e(route('q-decision.digital-advisor')); ?>" class="q-sub-card" data-tone="purple">
                    <div class="q-sub-card-icon">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="color: #6B46C1;">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/wesam../Downloads/QU_Projects/QUAI-demo2/resources/views/home/index.blade.php ENDPATH**/ ?>