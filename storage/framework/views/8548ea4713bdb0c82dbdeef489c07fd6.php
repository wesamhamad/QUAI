...
<aside class="q-sidebar" id="sidebar">
    ...
    <div class="q-sidebar-header">
        <a href="<?php echo e(route('home')); ?>" class="q-sidebar-logo" title="QUAI">
    ...
    <nav class="q-sidebar-nav q-scrollbar-hide">
        <a href="<?php echo e(route('home')); ?>"
           class="q-nav-item <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
        ...
        <a href="/qmentor"
           class="q-nav-item <?php echo e(request()->is('qmentor*') ? 'active' : ''); ?>">
            <svg class="q-nav-icon" width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('digital-record.index')); ?>"
           class="q-nav-item <?php echo e(request()->routeIs('digital-record.*') ? 'active' : ''); ?>">
            <svg class="q-nav-icon" width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('faculty.students')); ?>"
           class="q-nav-item <?php echo e(request()->routeIs('faculty.*') ? 'active' : ''); ?>">
            <svg class="q-nav-icon" width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="q-nav-divider"></div>
        <a href="<?php echo e(url('/admin/dashboards/ai-recommendations')); ?>"
           class="q-nav-item">
            <svg class="q-nav-icon" width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(url('/admin')); ?>" class="q-nav-item">
            <svg class="q-nav-icon" width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /Users/wesam../Downloads/QU_Projects/QUAI-demo2/resources/views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>