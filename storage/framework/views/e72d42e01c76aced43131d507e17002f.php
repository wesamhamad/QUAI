...
<head>
    ...
    <?php echo $__env->make('partials.meta-og', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<body class="min-h-screen flex bg-gray-50">
    ...
    <section class="flex-1 flex items-center justify-center p-6">
        <form method="POST" action="<?php echo e(route('demo.login.attempt')); ?>" autocomplete="off"
            ...
            <div class="mt-6 p-4 bg-dga-sa-50 border border-dga-sa-200 border-dashed rounded-xl">
                ...
                <div class="space-y-1.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button"
                                onclick="document.getElementById('quick-<?php echo e($loop->index); ?>').submit();"
                            ...
                            <span class="text-gray-500 font-mono" dir="ltr"><?php echo e($acc['username']); ?></span>
                            <span class="text-gray-700"><?php echo e($acc['label']); ?> · <?php echo e($acc['role']); ?></span>
                        </button>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form id="quick-<?php echo e($loop->index); ?>" method="POST" action="<?php echo e(route('demo.login.quick', $acc['username'])); ?>" class="hidden">
                <?php echo csrf_field(); ?>
            </form>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </section>
...
<?php /**PATH /Users/wesam../Downloads/QU_Projects/QUAI-demo2/resources/views/auth/demo-login.blade.php ENDPATH**/ ?>