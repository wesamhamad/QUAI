...
@section('title', 'التقرير الذاتي - QUAI')
@section('page-title', 'التقرير الذاتي')
    ...
    @foreach ($sections as $section)
        <section class="ai-section" id="ai-{{ $section['id'] }}">
            <div class="ai-section-head">
                ...
                <div class="ai-section-count">{{ count($section['recommendations']) }} توصية</div>
            </div>

            @if (count($section['recommendations']) === 0)
