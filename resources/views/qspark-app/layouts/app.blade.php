...
<body class="bg-dga-gray-50 min-h-screen text-dga-gray-900">
  ...
  <div class="flex min-h-screen">
    ...
    @unless(($isEmbedded ?? false) || $isStudentView)
      @include('qspark::layouts.sidebar')
    @endunless

    <main class="flex-1 flex flex-col">
      @unless($isEmbedded ?? false)
        @include('qspark::layouts.header')

        @if($isStudentView)
          @include('qspark::layouts.student-tabs')
        @endif
      @endunless
      ...
      @unless($isEmbedded ?? false)
        @include('qspark::layouts.footer')
      @endunless
    </main>
  </div>

  @include('qspark::layouts.terms-modal')

  @include('qspark::layouts.scripts')
