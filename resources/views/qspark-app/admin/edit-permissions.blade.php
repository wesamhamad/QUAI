...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            <a href="{{ route('qspark.admin.roles') }}" class="p-2 hover:bg-gray-100 rounded-lg transition">
    ...
    {{-- Permissions Form --}}
    <form action="{{ route('qspark.admin.permissions.update', ['role' => $role]) }}" method="POST" id="permissionsForm">
        @csrf
        @method('PUT')
