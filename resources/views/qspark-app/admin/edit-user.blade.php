...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('qspark.admin.users') }}" class="bg-gray-500 text-white px-4 py-2 rounded-xl hover:bg-gray-600 transition">
    ...
    <div class="bg-white rounded-2xl shadow p-6">
        <form method="POST" action="{{ route('qspark.admin.users.update', $user->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
