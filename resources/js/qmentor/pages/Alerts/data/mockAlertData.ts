...
export const analyticsData: AlertAnalyticsData = {
  ...
  severityOverTime: [
    { month: 'سبتمبر', monthEn: 'September', info: 45, warning: 23, urgent: 10, critical: 8 },
    { month: 'أكتوبر', monthEn: 'October', info: 52, warning: 31, urgent: 14, critical: 12 },
    { month: 'نوفمبر', monthEn: 'November', info: 38, warning: 28, urgent: 11, critical: 15 },
    { month: 'ديسمبر', monthEn: 'December', info: 61, warning: 35, urgent: 16, critical: 9 },
    { month: 'يناير', monthEn: 'January', info: 49, warning: 42, urgent: 19, critical: 18 },
    { month: 'فبراير', monthEn: 'February', info: 55, warning: 38, urgent: 13, critical: 11 },
    { month: 'مارس', monthEn: 'March', info: 43, warning: 29, urgent: 9, critical: 7 },
  ],
  responseTime: [
  ...
  resolutionRates: [
    { month: 'سبتمبر', monthEn: 'September', resolved: 62, pending: 28, escalated: 10 },
    { month: 'أكتوبر', monthEn: 'October', resolved: 58, pending: 32, escalated: 14 },
    { month: 'نوفمبر', monthEn: 'November', resolved: 71, pending: 22, escalated: 11 },
    { month: 'ديسمبر', monthEn: 'December', resolved: 65, pending: 25, escalated: 13 },
    { month: 'يناير', monthEn: 'January', resolved: 54, pending: 35, escalated: 19 },
    { month: 'فبراير', monthEn: 'February', resolved: 69, pending: 24, escalated: 12 },
    { month: 'مارس', monthEn: 'March', resolved: 74, pending: 20, escalated: 8 },
  ],
};
