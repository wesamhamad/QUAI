...
export const sessions: TutoringSession[] = [
  ...
  { id: 's3', tutorId: 't3', tutorNameAr: 'فهد محمد سعد', tutorNameEn: 'Fahad Mohammed Saad', studentNameAr: 'محمد الطالب', studentNameEn: 'Mohammed Student', subject: 'physics', date: '2026-04-10', startHour: 8, endHour: 10, location: 'campus', status: 'completed', rating: 5, notes: 'جلسة ممتازة في الديناميكا الحرارية' },
