...
const riskColors = {
  low: { bg: 'bg-sa-100 dark:bg-sa-900', text: 'text-sa-700 dark:text-sa-300', label: 'منخفض' },
  medium: { bg: 'bg-gold-100 dark:bg-gold-900', text: 'text-gold-700 dark:text-gold-300', label: 'متوسط' },
  high: { bg: 'bg-error-100 dark:bg-red-900', text: 'text-error-500 dark:text-red-300', label: 'مرتفع' },
  critical: { bg: 'bg-error-100 dark:bg-red-900', text: 'text-error-600 dark:text-red-200', label: 'حرج' },
};
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-0.5">
            <span className="text-sm font-semibold text-gray-900 dark:text-white truncate">{profile.name}</span>
          </div>
