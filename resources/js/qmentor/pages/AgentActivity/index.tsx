    ...
    <div className="min-h-screen">
      <div className="space-y-6 max-w-[1600px] mx-auto">
        ...
        <PageHeader
          ...
          subtitle={t(
            'ما نفّذه الوكيل: المهام والتنبيهات والمواعيد وطلبات الموافقة — عبر 8 فئات',
            'What the agent did: tasks, alerts, appointments and approvals — across 8 categories'
          )}
        ...
        {/* What the agent really wrote: the autonomy matrix, the approval queue, the last runs */}
        <LiveOverview />
      </div>
