...
export const mockConversations: Conversation[] = [
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        language: 'ar',
        list: {
          title: 'الجدول الدراسي - الفصل الأول ١٤٤٨',
          titleEn: 'Class Schedule - Fall 2026',
          rows: [
            { label: 'ACCT350 - المحاسبة المتوسطة (2)', labelEn: 'ACCT350 - Intermediate Accounting II', description: 'أحد، خميس ١١:٤٥-١:٠٠ | قاعة ٣٠٧٦', descriptionEn: 'Sun, Thu 11:45-1:00 | Room 3076' },
            { label: 'ISPM356 - القانون التجاري السعودي', labelEn: 'ISPM356 - Saudi Commercial Law', description: 'إثنين، أربعاء ٨:٠٠-٩:١٥ | قاعة ٢٠٢٩', descriptionEn: 'Mon, Wed 8:00-9:15 | Room 2029' },
            { label: 'ACCT353 - نظم المعلومات المحاسبية', labelEn: 'ACCT353 - Accounting Information Systems', description: 'إثنين، أربعاء ٩:٢٥-١٠:٤٠ | قاعة ٣٠٦٢', descriptionEn: 'Mon, Wed 9:25-10:40 | Room 3062' },
            { label: 'ACCT354 - المحاسبة الحكومية', labelEn: 'ACCT354 - Governmental Accounting', description: 'إثنين، أربعاء ١١:٤٥-١:٠٠ | قاعة ٣٠٤٩', descriptionEn: 'Mon, Wed 11:45-1:00 | Room 3049' },
            { label: 'ACCT355 - الزكاة والمحاسبة الضريبية', labelEn: 'ACCT355 - Zakat & Tax Accounting', description: 'ثلاثاء، خميس ١:١٥-٢:٣٠ | قاعة ٣٠٥١', descriptionEn: 'Tue, Thu 1:15-2:30 | Room 3051' },
          ],
        },
        quickReplies: [
  ...
  },
  {
    ...
    lastMessage: 'وجدت ٣ مدرسين متاحين لمادة المحاسبة المتوسطة (2)',
    lastMessageEn: 'Found 3 available tutors for Intermediate Accounting II',
    ...
    messages: [
      {
        ...
        role: 'user',
        type: 'text',
        content: 'أحتاج مدرس لمادة المحاسبة المتوسطة',
        contentEn: 'I need a tutor for Intermediate Accounting',
      ...
      },
      {
        ...
        role: 'assistant',
        type: 'list',
        content: 'وجدت المدرسين التالين المتاحين لمادة المحاسبة المتوسطة (2) ACCT350:',
        contentEn: 'Found the following available tutors for Intermediate Accounting II (ACCT350):',
        timestamp: '2026-04-10T09:15:00',
        language: 'ar',
        list: {
          title: 'مدرسون متاحون',
...
export function getMockResponse(query: string, lang: 'ar' | 'en'): Omit<import('../types').Message, 'id' | 'conversationId' | 'timestamp'> {
  ...
  if (lowerQuery.includes('جدول') || lowerQuery.includes('schedule')) {
    return {
      ...
      list: {
        ...
        rows: [
          { label: 'ACCT350 - المحاسبة المتوسطة (2)', labelEn: 'ACCT350 - Intermediate Accounting II', description: 'أحد، خميس ١١:٤٥-١:٠٠', descriptionEn: 'Sun, Thu 11:45-1:00' },
          { label: 'ISPM356 - القانون التجاري السعودي', labelEn: 'ISPM356 - Saudi Commercial Law', description: 'إثنين، أربعاء ٨:٠٠-٩:١٥', descriptionEn: 'Mon, Wed 8:00-9:15' },
          { label: 'ACCT353 - نظم المعلومات المحاسبية', labelEn: 'ACCT353 - Accounting Information Systems', description: 'إثنين، أربعاء ٩:٢٥-١٠:٤٠', descriptionEn: 'Mon, Wed 9:25-10:40' },
          { label: 'ACCT354 - المحاسبة الحكومية', labelEn: 'ACCT354 - Governmental Accounting', description: 'إثنين، أربعاء ١١:٤٥-١:٠٠', descriptionEn: 'Mon, Wed 11:45-1:00' },
          { label: 'ACCT355 - الزكاة والمحاسبة الضريبية', labelEn: 'ACCT355 - Zakat & Tax Accounting', description: 'ثلاثاء، خميس ١:١٥-٢:٣٠', descriptionEn: 'Tue, Thu 1:15-2:30' },
        ],
      },
      quickReplies: [
  ...
  return {
    role: 'assistant',
    type: 'text',
    content: 'شكراً لسؤالك! أنا مساعدك الأكاديمي الذكي في +QSpark. يمكنني مساعدتك في:\n\n• الاستفسار عن معدلك التراكمي\n• عرض جدولك الدراسي\n• البحث عن مدرسين\n• التقويم الأكاديمي\n• التواصل مع مرشدك\n\nكيف يمكنني مساعدتك؟',
    contentEn: 'Thank you for your question! I am your QSpark+ AI academic assistant. I can help you with:\n\n• Checking your GPA\n• Viewing your class schedule\n• Finding tutors\n• Academic calendar\n• Connecting with your advisor\n\nHow can I help you?',
    language: lang,
    quickReplies: [
