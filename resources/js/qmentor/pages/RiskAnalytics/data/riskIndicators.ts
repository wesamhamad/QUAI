...
export const riskIndicators: RiskIndicatorDef[] = [
  ...
  { id: 'AC07', nameAr: 'خطر الفصل', nameEn: 'Dismissal Risk', category: 'AC', descriptionAr: 'احتمالية الفصل الأكاديمي', descriptionEn: 'Academic dismissal probability', threshold: 30, currentValue: 18, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  ...
  { id: 'C01', nameAr: 'مؤشر المخاطر المركب', nameEn: 'Composite Risk Index', category: 'C', descriptionAr: 'مؤشر مركب من عدة فئات مخاطر', descriptionEn: 'Composite index from multiple risk categories', threshold: 50, currentValue: 35, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C02', nameAr: 'احتمال التسرب', nameEn: 'Dropout Probability', category: 'C', descriptionAr: 'احتمالية ترك الدراسة', descriptionEn: 'Probability of dropping out', threshold: 30, currentValue: 15, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C03', nameAr: 'مؤشر الأداء الشامل', nameEn: 'Holistic Performance Index', category: 'C', descriptionAr: 'مؤشر أداء شامل يجمع الأكاديمي والسلوكي', descriptionEn: 'Holistic index combining academic and behavioral', threshold: 60, currentValue: 55, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C04', nameAr: 'مؤشر التفاعل المتقاطع', nameEn: 'Cross-Engagement Index', category: 'C', descriptionAr: 'تفاعل متعدد الأبعاد (حضور + LMS + واجبات)', descriptionEn: 'Multi-dimensional engagement (attendance + LMS + assignments)', threshold: 65, currentValue: 48, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C05', nameAr: 'سرعة التدهور', nameEn: 'Decline Velocity', category: 'C', descriptionAr: 'سرعة تدهور الأداء الأكاديمي', descriptionEn: 'Speed of academic performance decline', threshold: 20, currentValue: 12, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C06', nameAr: 'استجابة التدخل', nameEn: 'Intervention Response', category: 'C', descriptionAr: 'مدى استجابة الطالب للتدخلات السابقة', descriptionEn: 'Student response to previous interventions', threshold: 60, currentValue: 50, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C07', nameAr: 'الإرشاد الأكاديمي', nameEn: 'Advising Engagement', category: 'C', descriptionAr: 'مستوى التفاعل مع المرشد الأكاديمي', descriptionEn: 'Academic advising engagement level', threshold: 60, currentValue: 48, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C08', nameAr: 'مقارنة الأقران', nameEn: 'Peer Comparison', category: 'C', descriptionAr: 'ترتيب الطالب بين أقرانه في نفس التخصص', descriptionEn: 'Student ranking among same-major peers', threshold: 50, currentValue: 38, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C09', nameAr: 'مؤشر الاستقرار', nameEn: 'Stability Index', category: 'C', descriptionAr: 'استقرار الأداء الأكاديمي عبر الفصول', descriptionEn: 'Academic performance stability across semesters', threshold: 70, currentValue: 58, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C10', nameAr: 'التوقع التنبؤي', nameEn: 'Predictive Forecast', category: 'C', descriptionAr: 'توقع الأداء للفصل القادم', descriptionEn: 'Next semester performance prediction', threshold: 60, currentValue: 52, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C11', nameAr: 'عامل التحفيز', nameEn: 'Motivation Factor', category: 'C', descriptionAr: 'مؤشر تحفيز الطالب المقدر بالسلوك', descriptionEn: 'Behavioral-inferred motivation indicator', threshold: 65, currentValue: 50, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  { id: 'C12', nameAr: 'الدعم الأسري', nameEn: 'Support Network', category: 'C', descriptionAr: 'مستوى الدعم الأسري والاجتماعي', descriptionEn: 'Family and social support network level', threshold: 60, currentValue: 55, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  ...
  { id: 'P03', nameAr: 'الفصول المتوقعة', nameEn: 'Expected Semesters', category: 'P', descriptionAr: 'عدد الفصول المتوقعة للتخرج', descriptionEn: 'Expected semesters to graduation', threshold: 2, currentValue: 3, status: 'high', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
  ...
  { id: 'P05', nameAr: 'معدل التخرج المتوقع', nameEn: 'Expected Graduation GPA', category: 'P', descriptionAr: 'المعدل المتوقع عند التخرج', descriptionEn: 'Projected GPA at graduation', threshold: 2.5, currentValue: 2.4, status: 'medium', dataSource: 'QSpark+ AI', dataSourceAr: '+QSpark' },
];
