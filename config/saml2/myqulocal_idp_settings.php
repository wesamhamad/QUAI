...
// MyQU Local IdP Configuration (for local development)
// IDP Host: http://127.0.0.1:8009
$this_idp_env_id = 'MYQULOCAL';
$idp_host = env('SAML2_'.$this_idp_env_id.'_IDP_HOST', 'http://127.0.0.1:8009');

return $settings = [
    'strict' => false,
    'debug' => env('SAML2_DEBUG', true),
