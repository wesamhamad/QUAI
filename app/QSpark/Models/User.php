...
{
    /** @use HasFactory<\Database\Factories\QSpark\UserFactory> */
    use HasFactory, Notifiable;

    /**
     * QSPARK keeps its own users table on the dedicated `qspark` connection,
     * isolated from QUAI's App\Models\User. See config/database.php.
     */
