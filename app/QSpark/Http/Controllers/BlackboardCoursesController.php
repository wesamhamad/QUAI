...
use App\QSpark\Http\Controllers\BlackboardConnectionController;
...
class BlackboardCoursesController extends Controller
{
    ...
    public function showUserCourses(Request $request)
    {
        ...
        try {
            ...
            return view('qspark::courses')->with('courses', $enrichedCourses);
    ...
    private function fallbackToTimetable()
    {
        ...
        return view('qspark::courses')->with('courses', $coursesFromTimeTable);
    }
    ...
    */
    ...
    public function showStaticCourses()
    {
        try {
            ...
            return view('qspark::courses')->with('courses', $formattedCourses);

        } catch (\Exception $e) {
            Log::error('Error in showStaticCourses: ' . $e->getMessage());
            return view('qspark::courses')->with('courses', []);
        }
    }
    ...
    private function fetchStudentCourses()
    {
        ...
        return Cache::remember($cacheKey, 900, function () use ($token) {
            ...
            if ($data === null) {
                ...
                if ($data !== null) {
                    \App\QSpark\Support\StudentFixture::logServed('BlackboardCoursesController.studentCoursesRaw', '/api/v2/student/courses');
                }
            }
