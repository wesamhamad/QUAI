...
class AdminDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('qspark::admin-dashboard', compact(
            'stats',
            'recentUsers',
            'dailyVisits',
            'topStudents',
    ...
    public function users()
    {
        ...
        return view('qspark::admin.users', compact('users'));
    }
    ...
    public function editUser($id)
    {
        ...
        return view('qspark::admin.edit-user', compact('user'));
    }
    ...
    public function updateUser(Request $request, $id)
    {
        ...
        return redirect()->route('qspark.admin.users')
    ...
    public function analytics()
    {
        ...
        return view('qspark::admin.analytics', compact('analytics'));
    }
    ...
    {
        return view('qspark::admin-dashboard-export', [
            'stats' => [
    ...
    public function roles()
    {
        ...
        return view('qspark::admin.roles', compact('roles'));
    }
    ...
    public function editRole($id)
    {
        ...
        return view('qspark::admin.edit-role', compact('role', 'usersWithRole'));
    }
    ...
    public function updateRole(Request $request, $id)
    {
        ...
        return redirect()->route('qspark.admin.roles')
    ...
    public function permissions()
    {
        ...
        return view('qspark::admin.permissions', compact('permissions'));
    }
    ...
    public function editPermissions($role)
    {
        ...
        if (! in_array($role, $validRoles)) {
            return redirect()->route('qspark.admin.permissions')->with('error', 'الدور غير موجود');
        }
        ...
        return view('qspark::admin.edit-permissions', compact('role', 'rolePermissions', 'availablePermissions'));
    }
    ...
    public function updatePermissions(Request $request, $role)
    {
        ...
        return redirect()->route('qspark.admin.permissions.edit', ['role' => $role])
