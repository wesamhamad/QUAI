...
use App\QSpark\Models\FacultyCourseCache;
use App\QSpark\Models\FacultyStudentCache;
...
class FacultyDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('qspark::faculty-dashboard', compact(
            'faculty',
            'stats',
            'studentsAtRisk',
            'topStudents',
    ...
    public function students()
    {
        ...
        return view('qspark::faculty.students', compact('students'));
    }
    ...
    public function viewStudent($id)
    {
        ...
        return view('qspark::faculty.view-student', compact('student', 'playHours'));
    }
    ...
    public function reports()
    {
        ...
        return view('qspark::faculty.reports', compact('reports'));
    }
...
6. استخدم اللغة العربية مع إبقاء أسماء المصادر بلغتها الأصلية";
    ...
    public function courses()
    {
        ...
        return view('qspark::faculty.courses', [
    ...
    public function viewCourse($courseCode)
    {
        ...
        return view('qspark::faculty.course-detail', [
            'course' => $course,
            'blackboard' => $blackboardData,
            'attachments' => $attachments,
            'contents' => $contents,
    ...
    public function editQuestion($questionId)
    {
        ...
        return view('qspark::faculty.edit-question', [
            'question' => $question,
            'course' => $course,
        ]);
    }
