...
class DemoData
{
    ...
    private static function marketAnalysisAcct(): array
    {
        return [
            'market_skills' => [
                ['skill' => 'تحليل البيانات المالية',  'skill_en' => 'Financial Data Analysis',  'weight' => 95, 'matched' => true],
                ['skill' => 'إعداد التقارير المالية',  'skill_en' => 'Financial Reporting',      'weight' => 92, 'matched' => true],
                ['skill' => 'Excel متقدم',              'skill_en' => 'Advanced Excel',           'weight' => 90, 'matched' => true],
                ['skill' => 'Power BI',                 'skill_en' => 'Power BI',                 'weight' => 85, 'matched' => false],
                ['skill' => 'SAP / ERP',                'skill_en' => 'SAP / ERP',                'weight' => 82, 'matched' => false],
                ['skill' => 'IFRS',                     'skill_en' => 'IFRS',                     'weight' => 78, 'matched' => true],
                ['skill' => 'لغة إنجليزية مهنية',       'skill_en' => 'Professional English',     'weight' => 75, 'matched' => true],
                ['skill' => 'مراجعة داخلية',            'skill_en' => 'Internal Audit',           'weight' => 70, 'matched' => false],
                ['skill' => 'Python للمحللين',         'skill_en' => 'Python for Analysts',      'weight' => 68, 'matched' => false],
                ['skill' => 'إدارة المشاريع',           'skill_en' => 'Project Management',       'weight' => 60, 'matched' => true],
            ],
            'gap_skills' => [
                ['skill' => 'Power BI',        'skill_en' => 'Power BI',             'weight' => 85],
                ['skill' => 'SAP / ERP',       'skill_en' => 'SAP / ERP',            'weight' => 82],
                ['skill' => 'مراجعة داخلية',    'skill_en' => 'Internal Audit',       'weight' => 70],
                ['skill' => 'Python للمحللين', 'skill_en' => 'Python for Analysts',  'weight' => 68],
                ['skill' => 'حوكمة البيانات',  'skill_en' => 'Data Governance',      'weight' => 55],
            ],
            'recommendations' => [
            ...
            'recommendations_en' => [
                'Enroll in a Power BI course on QSpark next semester.',
                'Volunteer for a small data-analytics project on campus to build experience.',
                'Earn a professional IFRS certification to strengthen your résumé.',
            ],
            ...
            'summary_en' => 'Your record shows good alignment with labor-market demand in accounting (60%), with gaps in Power BI, SAP/ERP, and Python.',
            'courses' => [
                ['title' => 'Microsoft Power BI for Business', 'title_en' => 'Microsoft Power BI for Business', 'platform' => 'Coursera', 'why' => 'يسدّ أعلى فجوة (Power BI · وزن 85).', 'why_en' => 'Closes your top skill gap (Power BI · weight 85).',        'url' => 'https://www.coursera.org/search?query=power+bi', 'live' => true],
                ['title' => 'SAP S/4HANA Financial Accounting', 'title_en' => 'SAP S/4HANA Financial Accounting', 'platform' => 'Udemy', 'why' => 'مهارة ERP مطلوبة بقوة (وزن 82).',       'why_en' => 'High-demand ERP skill (weight 82).',                                  'url' => 'https://www.udemy.com/topic/sap/', 'live' => true],
                ['title' => 'Python for Financial Analysts',    'title_en' => 'Python for Financial Analysts',    'platform' => 'edX',   'why' => 'يدعم التحليل الكمي وأتمتة التقارير.',     'why_en' => 'Supports quantitative analysis and automated reporting.',             'url' => 'https://www.edx.org/search?q=python+finance', 'live' => true],
            ],
            'jobs' => [
                ['title' => 'محلل بيانات مالية', 'title_en' => 'Financial Data Analyst', 'why' => 'يستثمر إتقانك لتحليل البيانات وExcel، مع فرصة لسدّ فجوة Power BI.', 'why_en' => 'Leverages your data analysis and Excel strengths, with room to close the Power BI gap.', 'url' => 'https://www.google.com/search?q=financial+data+analyst+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'محاسب IFRS معتمد',  'title_en' => 'Certified IFRS Accountant', 'why' => 'تطابق مباشر مع إتقانك لمعايير IFRS وإعداد التقارير المالية.',     'why_en' => 'Direct match with your mastery of IFRS standards and financial reporting.',           'url' => 'https://www.google.com/search?q=ifrs+accountant+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'مدقق داخلي',        'title_en' => 'Internal Auditor',          'why' => 'مرشّحة لسدّ فجوة المراجعة الداخلية المطلوبة (وزن 70).',          'why_en' => 'Targets your internal-audit gap (weight 70).',                                        'url' => 'https://www.google.com/search?q=internal+auditor+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
            ],
        ];
    }
    ...
    private static function marketAnalysisCS(): array
    {
        return [
            'market_skills' => [
                ['skill' => 'Python',               'skill_en' => 'Python',               'weight' => 95, 'matched' => true],
                ['skill' => 'الذكاء الاصطناعي',     'skill_en' => 'Artificial Intelligence', 'weight' => 92, 'matched' => true],
                ['skill' => 'تطوير الويب — React',   'skill_en' => 'Web Development — React', 'weight' => 90, 'matched' => true],
                ['skill' => 'AWS / السحابة',         'skill_en' => 'AWS / Cloud',          'weight' => 88, 'matched' => false],
                ['skill' => 'هياكل البيانات',        'skill_en' => 'Data Structures',      'weight' => 85, 'matched' => true],
                ['skill' => 'DevOps / CI/CD',        'skill_en' => 'DevOps / CI/CD',       'weight' => 78, 'matched' => false],
                ['skill' => 'تحليل البيانات',        'skill_en' => 'Data Analytics',       'weight' => 76, 'matched' => true],
                ['skill' => 'Kubernetes',            'skill_en' => 'Kubernetes',           'weight' => 68, 'matched' => false],
                ['skill' => 'الأمن السيبراني',      'skill_en' => 'Cybersecurity',        'weight' => 65, 'matched' => false],
                ['skill' => 'SQL',                   'skill_en' => 'SQL',                  'weight' => 60, 'matched' => true],
            ],
            'gap_skills' => [
                ['skill' => 'AWS / السحابة',   'skill_en' => 'AWS / Cloud',     'weight' => 88],
                ['skill' => 'DevOps / CI/CD',  'skill_en' => 'DevOps / CI/CD',  'weight' => 78],
                ['skill' => 'Kubernetes',      'skill_en' => 'Kubernetes',      'weight' => 68],
                ['skill' => 'الأمن السيبراني', 'skill_en' => 'Cybersecurity',   'weight' => 65],
                ['skill' => 'GraphQL',         'skill_en' => 'GraphQL',         'weight' => 50],
            ],
            'recommendations' => [
            ...
            'recommendations_en' => [
                ...
                'Complete the DevOps learning path on QSpark.',
            ],
            ...
            'summary_en' => 'Your record is strong in computer science (65%), with gaps in Cloud, DevOps, and Cybersecurity — skills in high demand in the Saudi market.',
            'courses' => [
                ['title' => 'AWS Certified Cloud Practitioner', 'title_en' => 'AWS Certified Cloud Practitioner', 'platform' => 'AWS Training', 'why' => 'أقوى فجوة مهارية في السوق.',                          'why_en' => 'Your largest market skill gap.',                              'url' => 'https://aws.amazon.com/training/', 'live' => true],
                ['title' => 'Docker & Kubernetes — DevOps Path','title_en' => 'Docker & Kubernetes — DevOps Path','platform' => 'Coursera',     'why' => 'يفتح أبواب وظائف SRE/DevOps.',                       'why_en' => 'Opens the door to SRE / DevOps roles.',                       'url' => 'https://www.coursera.org/search?query=kubernetes', 'live' => true],
                ['title' => 'Cybersecurity Fundamentals',       'title_en' => 'Cybersecurity Fundamentals',       'platform' => 'edX',          'why' => 'متطلب توظيف نامٍ بسرعة في القطاعين العام والخاص.', 'why_en' => 'A rapidly growing hiring requirement in public and private sectors.', 'url' => 'https://www.edx.org/search?q=cybersecurity', 'live' => true],
            ],
            'jobs' => [
                ['title' => 'مهندس سحابة (Cloud Engineer)', 'title_en' => 'Cloud Engineer',     'why' => 'يسدّ فجوة AWS الأعلى طلباً في السوق (وزن 88).',          'why_en' => 'Closes your top-demand AWS gap (weight 88).',           'url' => 'https://www.google.com/search?q=cloud+engineer+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'مطوّر Full-Stack',              'title_en' => 'Full-Stack Developer','why' => 'تطابق مع إتقانك لـ React وهياكل البيانات وSQL.',         'why_en' => 'Match for your skills in React, data structures, and SQL.', 'url' => 'https://www.google.com/search?q=full+stack+developer+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'محلل بيانات',                   'title_en' => 'Data Analyst',       'why' => 'يستثمر مهاراتك في Python وSQL وتحليل البيانات.',         'why_en' => 'Leverages your Python, SQL, and data-analytics skills.',     'url' => 'https://www.google.com/search?q=data+analyst+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
            ],
        ];
    }
    ...
    private static function marketAnalysisEE(): array
    {
        return [
            'market_skills' => [
                ['skill' => 'MATLAB / Simulink',       'skill_en' => 'MATLAB / Simulink',         'weight' => 92, 'matched' => true],
                ['skill' => 'أنظمة القوى',             'skill_en' => 'Power Systems',             'weight' => 88, 'matched' => true],
                ['skill' => 'إنترنت الأشياء IoT',       'skill_en' => 'Internet of Things (IoT)',  'weight' => 85, 'matched' => true],
                ['skill' => 'PLC والأتمتة الصناعية',    'skill_en' => 'PLC & Industrial Automation','weight' => 82, 'matched' => false],
                ['skill' => 'الإلكترونيات الرقمية',     'skill_en' => 'Digital Electronics',       'weight' => 80, 'matched' => true],
                ['skill' => 'مصادر الطاقة المتجددة',    'skill_en' => 'Renewable Energy',          'weight' => 75, 'matched' => false],
                ['skill' => 'Python للهندسة',           'skill_en' => 'Python for Engineering',    'weight' => 68, 'matched' => false],
                ['skill' => 'تصميم PCB',                'skill_en' => 'PCB Design',                'weight' => 65, 'matched' => true],
                ['skill' => 'الذكاء الاصطناعي للأنظمة', 'skill_en' => 'AI for Systems',            'weight' => 60, 'matched' => false],
            ],
            'gap_skills' => [
                ['skill' => 'PLC والأتمتة الصناعية',    'skill_en' => 'PLC & Industrial Automation','weight' => 82],
                ['skill' => 'مصادر الطاقة المتجددة',    'skill_en' => 'Renewable Energy',           'weight' => 75],
                ['skill' => 'Python للهندسة',           'skill_en' => 'Python for Engineering',     'weight' => 68],
                ['skill' => 'الذكاء الاصطناعي للأنظمة', 'skill_en' => 'AI for Systems',             'weight' => 60],
            ],
            'recommendations' => [
            ...
            'recommendations_en' => [
                'Complete the PLC learning path on QSpark.',
                'Enroll in the advanced renewable-energy course.',
                'Learn Python for engineering applications.',
            ],
            ...
            'summary_en' => 'Your record is well-balanced in electrical engineering (62%), with gaps in industrial automation and renewable energy — growing fields under Vision 2030.',
            'courses' => [
                ['title' => 'PLC Programming Fundamentals',  'title_en' => 'PLC Programming Fundamentals',  'platform' => 'Udemy',    'why' => 'يسدّ أعلى فجوة (وزن 82).',               'why_en' => 'Closes your top skill gap (weight 82).',                'url' => 'https://www.udemy.com/topic/plc/', 'live' => true],
                ['title' => 'Renewable Energy Systems',      'title_en' => 'Renewable Energy Systems',      'platform' => 'Coursera', 'why' => 'مجال نامٍ بسرعة في السعودية.',          'why_en' => 'A rapidly growing field in Saudi Arabia.',              'url' => 'https://www.coursera.org/search?query=renewable+energy', 'live' => true],
                ['title' => 'Python for Engineers',          'title_en' => 'Python for Engineers',          'platform' => 'edX',      'why' => 'يدعم أتمتة الحسابات وتحليل البيانات.', 'why_en' => 'Supports calculation automation and data analysis.',     'url' => 'https://www.edx.org/search?q=python+engineers', 'live' => true],
            ],
            'jobs' => [
                ['title' => 'مهندس أتمتة صناعية', 'title_en' => 'Industrial Automation Engineer', 'why' => 'مرشّحة لسدّ فجوة PLC والأتمتة الصناعية المطلوبة (وزن 82).', 'why_en' => 'Targets your PLC & industrial-automation gap (weight 82).', 'url' => 'https://www.google.com/search?q=industrial+automation+engineer+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'مهندس طاقة متجددة',  'title_en' => 'Renewable Energy Engineer',      'why' => 'مجال نامٍ ضمن رؤية 2030 ويسدّ فجوة مهارية لديك.',          'why_en' => 'A growing Vision 2030 field that closes one of your skill gaps.', 'url' => 'https://www.google.com/search?q=renewable+energy+engineer+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
                ['title' => 'مهندس أنظمة مدمجة',  'title_en' => 'Embedded Systems Engineer',      'why' => 'تطابق مع إتقانك للإلكترونيات الرقمية وتصميم PCB.',         'why_en' => 'Matches your strengths in digital electronics and PCB design.', 'url' => 'https://www.google.com/search?q=embedded+systems+engineer+jobs+saudi+arabia&ibp=htl;jobs', 'live' => true],
            ],
        ];
    }
    ...
    public static function topCourses(string $studentId): array
    {
        return [
            'acct' => [
                ['course_code' => 'ACCT301', 'course_name' => 'محاسبة مالية متوسطة (1)', 'course_name_en' => 'Intermediate Financial Accounting I', 'letter_grade' => 'A+','relevance' => 95],
                ['course_code' => 'ACCT311', 'course_name' => 'محاسبة التكاليف',         'course_name_en' => 'Cost Accounting',                     'letter_grade' => 'A', 'relevance' => 88],
                ['course_code' => 'BUSN320', 'course_name' => 'نظم معلومات إدارية',      'course_name_en' => 'Management Information Systems',      'letter_grade' => 'A+','relevance' => 80],
                ['course_code' => 'STAT302', 'course_name' => 'إحصاء تطبيقي للأعمال',    'course_name_en' => 'Applied Business Statistics',         'letter_grade' => 'A', 'relevance' => 75],
                ['course_code' => 'FIN301',  'course_name' => 'الإدارة المالية',         'course_name_en' => 'Financial Management',                'letter_grade' => 'A-','relevance' => 65],
                ['course_code' => 'ECON201', 'course_name' => 'الاقتصاد الجزئي',         'course_name_en' => 'Microeconomics',                      'letter_grade' => 'A+','relevance' => 40],
            ],
            'cs' => [
                ['course_code' => 'CS302', 'course_name' => 'قواعد البيانات',            'course_name_en' => 'Databases',                           'letter_grade' => 'A', 'relevance' => 95],
                ['course_code' => 'CS202', 'course_name' => 'تصميم وتحليل الخوارزميات',  'course_name_en' => 'Algorithm Design and Analysis',       'letter_grade' => 'A', 'relevance' => 90],
                ['course_code' => 'CS301', 'course_name' => 'نظم التشغيل',              'course_name_en' => 'Operating Systems',                   'letter_grade' => 'B+','relevance' => 80],
                ['course_code' => 'CS221', 'course_name' => 'تنظيم الحاسب',              'course_name_en' => 'Computer Organization',               'letter_grade' => 'B+','relevance' => 72],
                ['course_code' => 'STAT201','course_name' => 'الاحتمالات والإحصاء',      'course_name_en' => 'Probability and Statistics',          'letter_grade' => 'A-','relevance' => 65],
                ['course_code' => 'MATH301','course_name' => 'الجبر الخطي',              'course_name_en' => 'Linear Algebra',                      'letter_grade' => 'B', 'relevance' => 55],
            ],
            'ee' => [
                ['course_code' => 'EE240', 'course_name' => 'الإلكترونيات (1)',          'course_name_en' => 'Electronics I',                       'letter_grade' => 'A', 'relevance' => 95],
                ['course_code' => 'EE220', 'course_name' => 'الدوائر الكهربائية (2)',    'course_name_en' => 'Electric Circuits II',                'letter_grade' => 'B+','relevance' => 88],
                ['course_code' => 'EE260', 'course_name' => 'الإشارات والنظم',           'course_name_en' => 'Signals and Systems',                 'letter_grade' => 'B', 'relevance' => 78],
                ['course_code' => 'MATH301','course_name' => 'المعادلات التفاضلية',      'course_name_en' => 'Differential Equations',              'letter_grade' => 'A-','relevance' => 60],
                ['course_code' => 'PHYS102','course_name' => 'فيزياء عامة 2',            'course_name_en' => 'General Physics II',                  'letter_grade' => 'B', 'relevance' => 50],
            ],
        ][self::bundleKey($studentId)];
    }
